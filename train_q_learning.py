...
class Q_learning():
    ...
    def choose_action(self, state, action_mask): # In action_mask valule 0 - available action, 1 - not available 
        ...
        Chosen_action = None
        # epsilon greedy action choice. Action (Chosen_action) needs to be numpy array with 1 value. 0, 1 or 2
        # ---------------------------
...
if __name__ == "__main__":
    ...
    for episode in range(NUM_EPISODES):
        ...
        while not done:
            ...
            actions = ActionTuple(discrete=actions_discrete) # Need to change to ActionTuple because Unity accepts only this type
            # Set the actions
